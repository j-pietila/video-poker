...
class PokerGUI(tk.Tk):
    ...
    def createLayout(self):
        ...
        self.betButton = tk.Button(self.buttonArea, bg="blue", activebackground="medium blue", text="BET", font=("Courier", 20), command=lambda: [self.selectBetLevel()])
